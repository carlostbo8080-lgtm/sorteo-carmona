    ...
    >
      ...
      <div className="relative z-10 flex w-full max-w-3xl flex-col items-center text-center">
        <div className="relative mb-4">
          ...
          />
          <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-full shadow-[0_10px_30px_rgba(0,0,0,0.55)] ring-1 ring-white/20 animate-fade-in-up sm:h-[72px] sm:w-[72px]">
